...
| `tipo_metrica` | `distancia_ao_alvo` quando a nota é proximidade a um alvo de classe (IG duration fit, TIPS real-yield fit, Intl currency exposure, EM China exposure), não “mais alto / mais baixo” |
