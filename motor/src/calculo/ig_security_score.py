"""IG security selection — trend + RSI + volume + duration fit (Model 2)."""
...
def _load_duration_map() -> dict[str, float]:
    ...
    default = float(cfg.get("default", 6.0))
...
def _effective_duration(ticker: str, duration_map: dict[str, float]) -> float:
    return duration_map.get(ticker.upper(), duration_map.get("__default__", 6.0))
    ...
    for ticker in tickers:
        ...
        componentes = [
            ...
            },
            {
                ...
                "peso": wd,
                "contribuicao": c_dur,
                "role": "fit duration vs term premium — mapa estático por ticker",
            },
        ]
        ...
        explanation = [
            ...
            (
                f"Duration fit: P(dur)={dur_pct:.0%}, TP_pct={tp_pct:.0%} "
